...
public class Tree2 extends Entity {
	...
	private int frames = 0, maxFrames = 0, index = 0, maxIndex = 3;
	...
	public Tree2(int x, int y, int width, int height, BufferedImage sprite) {
	...
	public void CheckInterationsTree() {
		for(int i = 0; i < Game.entities.size(); i++) {
			...
			if(e instanceof Player) {
				if(Tree2.isColliddingMaskRange(e, this)) {
					if(Tree2.isChooseObject(this, Game.player)) {
						this.selected = true;
